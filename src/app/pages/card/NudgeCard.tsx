    ...
    const features = [
        {
            icon: Zap,
            title: "AI 소비 분석",
            description: "필수소비, 위험소비, 선택소비, 일반소비를 구분하여 소비 패턴을 분석합니다.",
        },
        {
            icon: TrendingDown,
            title: "자동 상환",
            description: "소비분석 대출 가입후 카드 결제시 자동상환비율에 따라서 자동 상환 처리됩니다.",
        },
        {
            icon: Shield,
            title: "신용점수 관리",
        ...
        <>
            <div className="min-h-screen bg-slate-50">
                <div className="mx-auto max-w-6xl px-6 pt-12 pb-6">
                    ...
                    <p className="mt-2 text-sm text-slate-400">카드 기능과 혜택을 확인하고 발급을 진행해보세요</p>
                </div>
                ...
                <div className="mx-auto max-w-6xl px-6 pb-14">
                    <div
                        ...
                        <div className="mx-auto max-w-5xl">
                            <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
                                <div>
                                    <h2 className="mb-2 text-2xl font-bold text-slate-900">넛지 체크카드</h2>
                                    <p className="mb-4 text-xl text-slate-400">AI가 분석하는 스마트한 소비 관리</p>
                                ...
                                <div className="relative md:-mt-5">
                                    {ownedCards.length > 0 && (
                                        <div className="mb-3 flex items-center justify-end gap-3">
                                            <label htmlFor="card-preview-select"
                                            ...
                                            <div className="relative flex h-full flex-col px-10 py-8">
                                                <div className="flex items-start justify-between">
                                                    ...
                                                    <div className="text-right">
                                                        <p
                                                            ...
                                                            style={{textShadow: "0 1px 0 #778196, 0 2px 4px rgba(0,0,0,0.5)"}}
                                                        >
                                                            NUDGEBANK
                                                        </p>
                                                    </div>
                                                ...
                                                <div className="mt-9">
                                                    <p
                                                        ...
                                                        style={{textShadow: "0 1px 0 #778196, 0 2px 4px rgba(0,0,0,0.4)"}}
                                                    >
                                                ...
                                                <div className="mt-auto space-y-3 pb-6">
                                                    <div
                                                        ...
                                                        style={{textShadow: "0 1px 0 #7a8498, 0 2px 0 #5f6879, 0 6px 14px rgba(0,0,0,0.5)"}}
                                                    >
                                                    ...
                                                    <div className="flex items-end justify-between text-[#e4eaf3]/85">
                                                        <div>
                                                            <p className="text-[9px] uppercase tracking-[0.22em] text-[#e4eaf3]/68">Valid
                                                                Thru</p>
                                                            <p
                                                                className="mt-1 font-mono text-[1.08rem] tracking-[0.06em] text-[#e7edf6]"
                                                                style={{textShadow: "0 1px 0 #7a8498, 0 2px 5px rgba(0,0,0,0.45)"}}
                                                            >
                                                                {cardPreview.expiredYm}
                                                            </p>
                                                        </div>
                                                        <div className="text-right">
                                                            <p className="text-[9px] uppercase tracking-[0.22em] text-[#e4eaf3]/68">Card
                                                                Holder</p>
                                                            <p
                            ...
                            {features.map((feature, index) => {
                                return (
                                    <div className="px-4 py-5 md:px-6" key={index}>
                                        ...
                                        <p className="mt-1 text-base leading-7 text-slate-500">{feature.description}</p>
                                    </div>
                                );
                            })}
                        </div>
                    ...
                    <div className="mb-8 rounded-2xl bg-white p-8 shadow-[0_2px_20px_rgba(0,0,0,0.08)]">
                        <h2 className="mb-6 text-2xl font-bold text-slate-900">체크카드 및 계좌 이용 안내</h2>

                        <div className="space-y-6 text-base leading-8 text-slate-600">
                            <section className="rounded-xl border border-slate-200 bg-slate-50/70 p-5">
                                <h3 className="mb-3 text-lg font-semibold text-slate-900">1. 발급 및 연결 단계</h3>
                                <p>
                                    <span className="font-semibold text-slate-800">통합 개설:</span>{" "}
                                    이 체크카드를 신청하면 결제 대금이 빠져나갈 전용 계좌가 동시에 생성됩니다.
                                </p>
                                <p>
                                    <span className="font-semibold text-slate-800">대출 필수 조건:</span>{" "}
                                    이 카드를 발급받아 보유하고 있어야만 대출 심사 및 실행이 가능합니다.
                                </p>
                            </section>

                            <section className="rounded-xl border border-slate-200 p-5">
                                <h3 className="mb-3 text-lg font-semibold text-slate-900">
                                    2. 소비분석 대출 상품 이용 시 (자동 상환)
                                </h3>
                                <p className="mb-2">
                                    이 카드의 가장 큰 특징은 <span className="font-semibold text-slate-800">"결제"가 곧 "상환"</span>으로
                                    이어진다는 점입니다.
                                </p>
                                <p>
                                ...
                                <div className="mt-4 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3">
                                    ...
                                    <p>
                                        본인 계좌에서 50,000원(결제 대금) + 2,500원(원금 상환액) = 총 52,500원이 인출됩니다.
                                    </p>
                                    <p className="mt-1">
                                        결과적으로 소비를 할 때마다 대출 잔액이 자동으로 줄어드는 구조입니다.
                                    </p>
                                </div>
                            </section>

                            <section className="rounded-xl border border-slate-200 p-5">
                                <h3 className="mb-3 text-lg font-semibold text-slate-900">3. 자기계발 대출 상품 이용 시</h3>
                                <p>
                                    <span className="font-semibold text-slate-800">단순 결제:</span>{" "}
                                    자기계발 대출은 카드 결제와 상환이 직접적으로 연동되지 않습니다.
                                </p>
                                <p>
                                    <span className="font-semibold text-slate-800">용도:</span>{" "}
                                    카드는 일반적인 체크카드 용도로 사용하며, 대출 상환은 별도의 정해진 스케줄에 따라 이루어집니다.
                                </p>
                            </section>

                            <section>
                                <h3 className="mb-3 text-lg font-semibold text-slate-900">요약 비교</h3>
                                <div className="overflow-hidden rounded-xl border border-slate-200">
                                    ...
                                    <div
                                        ...
                                        <div className="font-semibold text-slate-800">카드/계좌 발급</div>
                                        <div>필수</div>
                                        <div>필수</div>
                                    </div>
                                    <div
                                        className="grid grid-cols-[150px_1fr_1fr] gap-4 border-b border-slate-100 px-4 py-3">
                                        <div className="font-semibold text-slate-800">주요 상환 방식</div>
                                        <div>카드 결제 시 자동 상환 및 수동 상환</div>
                                        <div>수동 상환</div>
                                    </div>
                                    <div className="grid grid-cols-[150px_1fr_1fr] gap-4 px-4 py-3">
                                        <div className="font-semibold text-slate-800">결제와 상환의 관계</div>
