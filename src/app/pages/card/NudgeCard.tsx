    ...
    <>
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto max-w-6xl px-6 pb-14">
          <div className="group mb-8 overflow-hidden rounded-2xl bg-white p-10 shadow-[0_2px_20px_rgba(0,0,0,0.08)] transition-all hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
              ...
              <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
                ...
                <div className="relative md:-mt-5">
                  ...
                  <div className="mx-auto flex max-w-md justify-center">
                    ...
                    >
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(255,255,255,0.12),transparent_22%),radial-gradient(circle_at_78%_8%,rgba(245,214,150,0.10),transparent_20%),linear-gradient(120deg,transparent_0%,rgba(255,255,255,0.04)_42%,transparent_58%)]" />
                      <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-white/10 to-transparent" />
                      <div className="absolute -left-10 bottom-0 h-28 w-36 rounded-full bg-black/30 blur-3xl" />
                      <div className="absolute right-0 top-12 h-24 w-24 rounded-full bg-amber-200/10 blur-2xl" />
                      <div className="relative flex h-full flex-col px-10 py-8">
                        <div className="flex items-start justify-between">
                          <div className="relative h-10 w-[5.5rem] rounded-2xl bg-gradient-to-br from-[#e8edf5]/45 to-[#8a93a3]/30 backdrop-blur-sm ring-1 ring-[#d7deea]/40">
                            <img
                              src={elephantImage}
                              alt=""
            ...
            <div className="space-y-6 text-base leading-8 text-slate-600">
              ...
              <section>
                ...
                <div className="overflow-hidden rounded-xl border border-slate-200">
                  <div className="grid grid-cols-[150px_1fr_1fr] gap-4 border-b border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-500">
                    <div>구분</div>
                    <div>넛지 대출</div>
                    <div>자기계발 대출</div>
                  </div>
                  <div className="grid grid-cols-[150px_1fr_1fr] gap-4 border-b border-slate-100 px-4 py-3">
              ...
              <div className="border-b border-blue-200/80 bg-gradient-to-r from-blue-200/70 via-sky-100/80 to-purple-100/70 px-8 py-6">
                <DialogHeader className="text-left">
                  ...
                  <DialogDescription className="text-sm text-slate-600">
                    계좌 생성과 카드 발급이 모두 완료되었습니다. 아래 정보를
                    확인해주세요.
                  </DialogDescription>
                </DialogHeader>
              </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-xl border border-blue-200/80 bg-white/80 p-5 shadow-sm">
                    ...
                    <div className="space-y-3 text-sm text-slate-600">
                      <div>
                        <label
                          className="mb-1 block text-slate-800"
